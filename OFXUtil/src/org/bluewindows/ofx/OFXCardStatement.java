...
public class OFXCardStatement extends AbstractAggregate {
	// OFX CCSTMTRS Object
	
	String curDef = "";
	OFXCardAcctFrom cardAcctFrom = new OFXCardAcctFrom();
	...
	public OFXCardAcctFrom getCardAcctFrom() {
		return cardAcctFrom;
	}
	...
	public void setCardAcctFrom(OFXCardAcctFrom cardAcctFrom) throws ParseException {
		dupeCheck(this.cardAcctFrom);
		this.cardAcctFrom = cardAcctFrom;
	}
