...
public class OFXBankStatementResponse extends AbstractAggregate {
	//OFX STMTRNRS object
	
	private String transUID = "";
	private OFXStatus status = new OFXStatus();
	private ArrayList<OFXBankStatement> statements = new ArrayList<OFXBankStatement>();
	...
	public ArrayList<OFXBankStatement> getStatements() {
		return statements;
	}
	
	public void addStatement(OFXBankStatement statement){
