...
public class HandleOFXBankAcctFrom extends AbstractTagHandler {

	//Set this class up as a Singleton
	public final static HandleOFXBankAcctFrom INSTANCE = new HandleOFXBankAcctFrom();
	protected HandleOFXBankAcctFrom() {}

	@Override
	public HandlerResult handle(OFXParser parser, AbstractAggregate aggregate, Tag tag) throws ParseException {
		OFXBankAcctFrom contentObject = convertContentToObject("", tag, parser);
	...
	@Override
	public OFXBankAcctFrom convertContentToObject(String contentString, Tag tag, OFXParser parser) throws ParseException {
		return new OFXBankAcctFrom();
	}
