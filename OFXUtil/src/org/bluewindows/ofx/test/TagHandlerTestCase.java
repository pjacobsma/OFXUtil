...
public abstract class TagHandlerTestCase extends TestCase {
	
	protected MockInputStream inStream;
	protected OFXParser parser;
	
	
	protected void initialize(String inString) throws Exception {
		inStream = new MockInputStream(inString);
		parser = new OFXParser(inStream);
	}
}
