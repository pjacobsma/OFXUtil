...
public class HandleAggClose extends AbstractTagHandler {
	...
	@Override //This method doesn't do anything because all this handler does is mark the aggregate complete.
